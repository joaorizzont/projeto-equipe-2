...
export const EventCard: React.FC<EventCardProps> = ({ event }) => {
  ...
  return (
    <Link to={`/eventos/${event.id}`} className="group bg-white rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(79,70,229,0.08)] hover:border-indigo-100 overflow-hidden transition-all duration-300 flex flex-col h-full cursor-pointer block">
